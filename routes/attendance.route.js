...
const { mark_attendance, update_attendance, get_attendance } = require('../controllers/attendance.controller')
const validate = require('../middlewares/validate.middleware')
const { mark_attendance_schema, update_attendance_schema } = require('../schemas/attendance.schema')
